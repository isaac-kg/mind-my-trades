const Footer = () => {
  return (
    <div>
        <div className="card w-11/12 mx-auto text-white md:text-left md:flex justify-between items-center">
            <div>

        <p className="text-4xl">Create your account to join crypto trading and investing.</p>
        <p>Unlock the future of finance! Join us now and embark on a journey into the world of cryptocurrency.</p>
            </div>
      ...
      <div className="md:flex justify-between flex-wrap">
        ...
        <div className="md:basis-1/2 lg:basis-1/4">
          ...
          <p>Subscribe to get our latest information about FooCoinExchange.</p>
          <div className="md:flex flex-wrap gap-x-4">
            ...
            />
            <div></div>
            <button className="button whitespace-nowrap mt-6">
              Subscribe
            </button>
          </div>
        </div>
